...
from app.services.ai_provider import AIProvider, TaskType, AIResponse, ProviderStatus
...
class AIFallbackManager:
    ...
    def _create_basic_intelligent_search_response(self, context: Dict[str, Any]) -> AIResponse:
        ...
        return AIResponse(
            ...
            metadata={
                "fallback_used": True,
                "fallback_type": "basic_intelligent_search"
            },
            provider="fallback_manager",
    ...
    def _create_basic_suggestions_response(self, context: Dict[str, Any]) -> AIResponse:
        ...
        return AIResponse(
            ...
            metadata={
                "fallback_used": True,
                "fallback_type": "basic_suggestions"
            },
            provider="fallback_manager",
    ...
    def _create_basic_recommendations_response(self, context: Dict[str, Any]) -> AIResponse:
        ...
        return AIResponse(
            ...
            metadata={
                "fallback_used": True,
                "fallback_type": "basic_recommendations"
            },
            provider="fallback_manager",
