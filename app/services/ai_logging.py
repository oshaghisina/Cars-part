...
class AILogger:
    ...
    def log_request(self, correlation_id: str, operation: str, provider: str, request_data: Dict[str, Any]) -> None:
        ...
        log_data = self._format_log_data(
            ...
            operation,
            provider,
            {"type": "request", "request": request_data},
        )
    ...
    def log_response(
        ...
        log_data = self._format_log_data(
            ...
            operation,
            provider,
            {"type": "response", "response": response_data},
            duration_ms,
        )
    ...
    def log_error(
        ...
        log_data = self._format_log_data("ERROR", correlation_id, operation, provider, error_data)
    ...
    def log_provider_status(self, provider: str, status: str, details: Optional[Dict[str, Any]] = None) -> None:
        ...
        log_data = self._format_log_data(
            ...
            "provider_status",
            provider,
            {"type": "status_change", "status": status, "details": details or {}},
        )
    ...
    def log_cost_tracking(self, correlation_id: str, provider: str, operation: str, cost_data: Dict[str, Any]) -> None:
        ...
        log_data = self._format_log_data(
            ...
            operation,
            provider,
            {"type": "cost_tracking", "cost": cost_data},
        )
