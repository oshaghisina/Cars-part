...
class PartsService:
    ...
    def get_parts(self, skip: int = 0, limit: int = 100, status: Optional[str] = None,
        ...
        for index, row in df.iterrows():
            try:
                ...
                part_data = {
                    ...
                    'vehicle_trim': str(row.get('vehicle_trim', '')).strip() if pd.notna(row.get('vehicle_trim')) else None,
