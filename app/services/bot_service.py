...
class BotService:
    ...
    def search_multiple_parts(self, queries: List[str]) -> Dict:
        ...
        if found_count == 0:
            ...
            summary_message = f"✅ {found_count} از {len([q for q in queries if q.strip()])} قطعه یافت شد."
    ...
    def handle_contact_capture(self, telegram_user_id: str, phone_number: str = None,
    ...
    def create_order_from_search_results(self, telegram_user_id: str, 
