...
class Part(Base):
    ...
    stock_level = relationship(
        "StockLevel", back_populates="part", uselist=False, cascade="all, delete-orphan"
    )
    price_info = relationship(
        "PartPrice", back_populates="part", uselist=False, cascade="all, delete-orphan"
    )
...
class User(Base):
    ...
    # otp_codes = relationship("app.models.otp_models.OTPCode",
    #                         back_populates="user", cascade="all, delete-orphan")
    # phone_verifications = relationship("app.models.otp_models.PhoneVerification",
    #                                   back_populates="user", cascade="all, delete-orphan")
    # telegram_user = relationship("app.models.telegram_models.TelegramUser",
