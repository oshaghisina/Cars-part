...
class SMSTemplateUpdate(BaseModel):
    ...
    is_active: Optional[bool] = Field(
        None, description="Whether template is active")
...
class SMSCampaignCreate(BaseModel):
    ...
    description: Optional[str] = Field(
        None, description="Campaign description")
    template_id: int = Field(..., description="Template ID to use")
    target_audience: str = Field(..., description="Target audience")
    scheduled_at: Optional[datetime] = Field(
        None, description="Scheduled send time")
...
class UserSMSPreferences(BaseModel):
    ...
    sms_notifications: bool = Field(
        default=True, description="General SMS notifications")
    sms_marketing: bool = Field(default=False, description="Marketing SMS")
    sms_delivery: bool = Field(
        default=True,
...
class UserSMSPreferencesUpdate(BaseModel):
    ...
    sms_notifications: Optional[bool] = Field(
        None, description="General SMS notifications")
    sms_marketing: Optional[bool] = Field(None, description="Marketing SMS")
    sms_delivery: Optional[bool] = Field(
        None, description="Delivery notifications")
...
class BulkSMSRequest(BaseModel):
    ...
    template_id: Optional[int] = Field(
        None, description="Template ID for tracking")
...
class BulkSMSResponse(BaseModel):
    ...
    total_cost: float = Field(..., description="Total cost")
    results: List[SMSResponse] = Field(...,
                                       description="Individual SMS results")
...
class PhoneVerificationResponse(BaseModel):
    ...
    verification_id: Optional[str] = Field(
        None, description="Verification session ID")
