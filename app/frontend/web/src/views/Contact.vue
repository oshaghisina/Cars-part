      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div class="bg-white rounded-lg shadow-md p-8">
          ...
          <form @submit.prevent="submitContact" class="space-y-4">
            <div>
              <label class="block text-sm font-medium text-gray-700 mb-2 font-persian">Name *</label>
              <input
                v-model="form.name"
                type="text"
                required
            ...
            <div>
              <label class="block text-sm font-medium text-gray-700 mb-2 font-persian">Email *</label>
              <input
                v-model="form.email"
                type="email"
                required
            ...
            <div>
              <label class="block text-sm font-medium text-gray-700 mb-2 font-persian">Subject *</label>
              <select
            ...
            <div>
              <label class="block text-sm font-medium text-gray-700 mb-2 font-persian">Message *</label>
              <textarea
        ...
        <div class="space-y-6">
          ...
          <div class="bg-white rounded-lg shadow-md p-6">
            ...
            <div class="space-y-2 text-sm font-persian">
              <div class="flex justify-between">
                ...
                <span class="text-gray-600 font-persian">9:00 AM - 6:00 PM (CST)</span>
              </div>
              <div class="flex justify-between">
                <span>Saturday</span>
                <span class="text-gray-600 font-persian">9:00 AM - 2:00 PM (CST)</span>
              </div>
              <div class="flex justify-between">
                <span>Sunday</span>
                <span class="text-gray-600 font-persian">Closed</span>
              </div>
            </div>
          </div>
          ...
          <div class="bg-white rounded-lg shadow-md p-6">
            ...
            <div class="space-y-2">
              ...
              <router-link to="/quote" class="block text-blue-600 hover:text-blue-800 font-persian">
                Request Quote
              </router-link>
              <router-link to="/track" class="block text-blue-600 hover:text-blue-800 font-persian">
                Track Order
              </router-link>
              <a href="/panel/" class="block text-blue-600 hover:text-blue-800 font-persian">
                Admin Panel
              </a>
            </div>
          </div>
