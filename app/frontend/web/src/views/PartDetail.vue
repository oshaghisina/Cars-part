  ...
  <div class="part-detail">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div v-if="loading" class="text-center py-12 font-persian font-persian">
        ...
        <p class="mt-2 text-gray-600 font-persian font-persian" class="font-persian text-rtl">Loading part details...</p>
      </div>
      ...
      <div v-else-if="part" class="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
          <div class="w-full h-64 bg-gray-200 rounded-lg mb-4 flex items-center justify-center">
            <span class="text-6xl font-persian font-persian">🔧</span>
          </div>
          <h1 class="text-2xl font-bold text-gray-900 mb-2 font-persian font-persian" class="font-persian-bold text-rtl">{{ part.name }}</h1>
          <p class="text-gray-600 mb-4 font-persian font-persian" class="font-persian text-rtl">{{ part.description }}</p>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
          <div class="mb-6">
            <div class="flex justify-between items-center mb-4">
              <span class="text-3xl font-bold text-blue-600 font-persian font-persian">${{ part.price }}</span>
              <span class="text-sm text-gray-500 font-persian font-persian">{{ part.stock }} in stock</span>
            </div>
            
            <div class="space-y-2 text-sm text-gray-600 font-persian font-persian">
          ...
          <div class="space-y-4">
            <button
              @click="requestQuote"
              class="w-full bg-blue-600 text-white py-3 rounded-lg font-semibold hover:bg-blue-700 transition-colors font-persian font-persian"
            >
              Request Quote
            </button>
            ...
            <button
              @click="addToCart"
              class="w-full border-2 border-blue-600 text-blue-600 py-3 rounded-lg font-semibold hover:bg-blue-50 transition-colors font-persian font-persian"
            >
              Add to Cart
            </button>
          </div>
          ...
          <div class="mt-6 pt-6 border-t border-gray-200">
            <h3 class="font-semibold text-gray-900 mb-2 font-persian font-persian" class="font-persian-bold text-rtl">Specifications</h3>
            <div class="space-y-1 text-sm text-gray-600 font-persian font-persian">
      ...
      <div v-else class="text-center py-12 font-persian font-persian">
        ...
        <h3 class="text-xl font-semibold text-gray-900 mb-2 font-persian font-persian" class="font-persian-bold text-rtl">Part not found</h3>
        <p class="text-gray-600 mb-4 font-persian font-persian" class="font-persian text-rtl">The requested part could not be found.</p>
        <router-link
          to="/search"
