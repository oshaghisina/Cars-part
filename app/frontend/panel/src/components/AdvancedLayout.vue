    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
      ...
      <div class="bg-white rounded-lg shadow-sm border border-gray-200">
        ...
        <div class="px-6 py-4 border-b border-gray-200">
          <div class="flex items-center justify-between">
            <h2 class="text-lg font-medium text-gray-900">{{ contentTitle }}</h2>
            <div class="flex items-center space-x-2">
              <!-- Pagination Info -->
        ...
        <div v-if="pagination.total > pagination.perPage" class="px-6 py-4 border-t border-gray-200">
          <div class="flex items-center justify-between">
...
export default {
  ...
  emits: ['search', 'refresh', 'page-change', 'per-page-change', 'view-mode-change', 'selection-change'],
  setup(props, { emit }) {
    ...
    const goToPage = (page) => {
      if (page !== pagination.value.currentPage && page >= 1 && page <= pagination.value.totalPages) {
    ...
    watch(() => props.totalItems, (newTotal) => {
      ...
      pagination.value.totalPages = Math.ceil(newTotal / pagination.value.perPage)
    })
