  ...
  <div class="space-y-6">
    ...
    <div class="chart-container">
      ...
      <div v-else class="space-y-3">
        <div v-for="(count, range) in analytics.price_distribution" :key="range" class="flex items-center">
          ...
          <div class="w-16 text-sm text-gray-900 text-right">{{ formatNumber(count) }}</div>
        </div>
      </div>
    </div>
      ...
      <div v-else class="overflow-hidden">
        <table class="min-w-full divide-y divide-gray-200">
          ...
          <tbody class="bg-white divide-y divide-gray-200">
            <tr v-for="item in analytics.low_stock_items.slice(0, 10)" :key="item.id">
    ...
    <div class="chart-container">
      ...
      <div v-else class="grid grid-cols-2 md:grid-cols-4 gap-4">
        <div v-for="(count, status) in analytics.status_distribution" :key="status" class="text-center">
          <div class="text-2xl font-semibold text-gray-900">{{ formatNumber(count) }}</div>
