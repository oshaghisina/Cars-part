      ...
      <div v-else class="overflow-hidden">
        <table class="min-w-full divide-y divide-gray-200">
          ...
          <tbody class="bg-white divide-y divide-gray-200">
            <tr v-for="customer in analytics.top_customers" :key="customer.customer_name">
        ...
        <div v-if="analytics.top_customers.length === 0" class="text-center py-8">
    ...
    <div class="chart-container">
      ...
      <div v-else class="overflow-hidden">
        <table class="min-w-full divide-y divide-gray-200">
          ...
          <tbody class="bg-white divide-y divide-gray-200">
            <tr v-for="trend in analytics.revenue_trends.slice(-7)" :key="trend.date">
              <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
        ...
        <div v-if="analytics.revenue_trends.length === 0" class="text-center py-8">
