            ...
            <div class="p-4">
              ...
              <div class="grid grid-cols-2 gap-3 mb-4">
                <div class="bg-blue-50 p-3 rounded-lg">
                  <div class="text-sm text-blue-600 font-medium">Total Parts</div>
                  <div class="text-xl font-bold text-blue-900">{{ analyticsMetrics.totalParts || 0 }}</div>
                </div>
                <div class="bg-green-50 p-3 rounded-lg">
                  <div class="text-sm text-green-600 font-medium">Total Orders</div>
                  <div class="text-xl font-bold text-green-900">{{ analyticsMetrics.totalOrders || 0 }}</div>
                </div>
                <div class="bg-purple-50 p-3 rounded-lg">
                  <div class="text-sm text-purple-600 font-medium">Active Users</div>
                  <div class="text-xl font-bold text-purple-900">{{ analyticsMetrics.activeUsers || 0 }}</div>
                </div>
                <div class="bg-orange-50 p-3 rounded-lg">
                  <div class="text-sm text-orange-600 font-medium">Revenue</div>
                  <div class="text-xl font-bold text-orange-900">{{ formatCurrency(analyticsMetrics.totalRevenue || 0) }}</div>
                </div>
              </div>
