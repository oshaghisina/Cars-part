<template>
  <div class="ai-analytics">
    <div class="analytics-header mb-6">
      <h2 class="text-2xl font-bold text-gray-800 mb-2">📊 AI Analytics</h2>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-white p-6 rounded-lg border border-gray-200">
          ...
          <div class="text-3xl font-bold text-green-600 mb-2">
            {{ featureUsage.recommendations || 0 }}
          </div>
        ...
        <div class="bg-white p-6 rounded-lg border border-gray-200">
          ...
          <div class="text-3xl font-bold text-purple-600 mb-2">
            {{ featureUsage.languageAnalysis || 0 }}
          </div>
          ...
          <div>
            ...
            <div class="space-y-2">
              ...
              <div class="flex justify-between">
                ...
                <span
                  :class="
                    aiStatus.experimental ? 'text-yellow-600' : 'text-gray-600'
                  "
                  class="text-sm font-medium"
                >
