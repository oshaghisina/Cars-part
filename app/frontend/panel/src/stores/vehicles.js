...
export const useVehicleBrandsStore = defineStore('vehicleBrands', {
  ...
  getters: {
    ...
    brandsWithModels: (state) => state.brands.filter(brand => brand.models && brand.models.length > 0)
  },
  ...
  actions: {
    ...
    async createBrand(brandData) {
      ...
      this.error = null
      try {
        const response = await axios.post(`${API_BASE}/vehicles/brands`, brandData)
    ...
    async updateBrand(id, brandData) {
      ...
      this.error = null
      try {
        const response = await axios.put(`${API_BASE}/vehicles/brands/${id}`, brandData)
...
export const useVehicleModelsStore = defineStore('vehicleModels', {
  ...
  getters: {
    ...
    modelsByBrand: (state) => (brandId) => state.models.filter(model => model.brand_id === brandId)
  },
  ...
  actions: {
    ...
    async createModel(modelData) {
      ...
      this.error = null
      try {
        const response = await axios.post(`${API_BASE}/vehicles/models`, modelData)
    ...
    async updateModel(id, modelData) {
      ...
      this.error = null
      try {
        const response = await axios.put(`${API_BASE}/vehicles/models/${id}`, modelData)
...
export const useVehicleTrimsStore = defineStore('vehicleTrims', {
  ...
  getters: {
    ...
    trimsByModel: (state) => (modelId) => state.trims.filter(trim => trim.model_id === modelId)
  },
  ...
  actions: {
    ...
    async createTrim(trimData) {
      ...
      this.error = null
      try {
        const response = await axios.post(`${API_BASE}/vehicles/trims`, trimData)
    ...
    async updateTrim(id, trimData) {
      ...
      this.error = null
      try {
        const response = await axios.put(`${API_BASE}/vehicles/trims/${id}`, trimData)
