    ...
    <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
              ...
              <div class="ml-5 w-0 flex-1">
                <dl>
                  ...
                  <dd class="text-lg font-medium text-gray-900">
                    {{ usersStore.statistics.totalUsers }}
                  </dd>
                </dl>
              </div>
            </div>
            ...
            <div class="flex items-center">
              ...
              <div class="ml-5 w-0 flex-1">
                <dl>
                  ...
                  <dd class="text-lg font-medium text-gray-900">
                    {{ usersStore.statistics.activeUsers }}
                  </dd>
                </dl>
              </div>
            </div>
            ...
            <div class="flex items-center">
              ...
              <div class="ml-5 w-0 flex-1">
                <dl>
                  ...
                  <dd class="text-lg font-medium text-gray-900">
                    {{ usersStore.statistics.verifiedUsers }}
                  </dd>
                </dl>
              </div>
            </div>
            ...
            <div class="flex items-center">
              ...
              <div class="ml-5 w-0 flex-1">
                <dl>
                  ...
                  <dd class="text-lg font-medium text-gray-900">
                    {{ usersStore.statistics.recentLogins }}
                  </dd>
                </dl>
              </div>
            </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <div>
            ...
            <select
              ...
              class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500"
              @change="
                usersStore.setFilter('isActive', usersStore.filters.isActive)
              "
            >
      ...
      <div class="bg-white shadow overflow-hidden sm:rounded-md">
        ...
        <ul v-else class="divide-y divide-gray-200">
          <li
            v-for="user in usersStore.getPaginatedUsers"
            :key="user.id"
            class="px-6 py-4"
          >
                  ...
                  <div class="flex items-center">
                    ...
                    <span
                      :class="[
                        ...
                        usersStore.getRoleColor(user.role) === 'red'
                          ? 'bg-red-100 text-red-800'
                          : usersStore.getRoleColor(user.role) === 'blue'
                            ? 'bg-blue-100 text-blue-800'
                            : usersStore.getRoleColor(user.role) === 'green'
              ...
              <div class="flex items-center space-x-4">
                <div class="text-right">
                  ...
                  <p class="text-xs text-gray-400 mt-1">
                    Last login:
                    {{ usersStore.formatLastLogin(user.last_login) }}
                  </p>
                </div>
            ...
            <div>
              <p class="text-sm text-gray-700">
                ...
                <span class="font-medium">{{
                  (usersStore.pagination.currentPage - 1) *
...
export default {
  ...
  setup() {
    ...
    const goToNextPage = () => {
      if (
        usersStore.pagination.currentPage < usersStore.pagination.totalPages
      ) {
        usersStore.setCurrentPage(usersStore.pagination.currentPage + 1);
      }
    };
