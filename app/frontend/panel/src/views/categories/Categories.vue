      ...
      <div class="flex justify-between items-center">
        <div>
          ...
          <p class="text-gray-600 mt-2">
            Manage hierarchical part categories with tree structure
          </p>
        </div>
          ...
          <div class="flex items-center">
            ...
            <div class="ml-5 w-0 flex-1">
              <dl>
                ...
                <dd class="text-lg font-medium text-gray-900">
                  {{ categoriesStore.rootCategories.length }}
                </dd>
              </dl>
            </div>
          </div>
          ...
          <div class="flex items-center">
            ...
            <div class="ml-5 w-0 flex-1">
              <dl>
                ...
                <dd class="text-lg font-medium text-gray-900">
                  {{ categoriesStore.activeCategories.length }}
                </dd>
              </dl>
            </div>
          </div>
          ...
          <div class="p-6">
            ...
            <div v-else class="space-y-4">
              ...
              <div class="border-b border-gray-200 pb-4">
                ...
                <div
                  v-if="selectedCategory.name_fa"
                  class="text-sm text-gray-600 mt-1"
                >
                  {{ selectedCategory.name_fa }}
                </div>
                <div
                  v-if="selectedCategory.name_cn"
                  class="text-sm text-gray-600 mt-1"
                >
              ...
              <div v-if="categoryPath.length > 1">
                ...
                <div class="flex items-center space-x-1 text-sm text-gray-600">
                  ...
                  >
                    ...
                    <span v-if="index < categoryPath.length - 1" class="mx-1"
                      >›</span
                    >
                  </span>
                </div>
        ...
        <div class="mt-3">
          ...
          <div class="mt-3 text-center">
            ...
            <div class="mt-2">
              ...
              <p
                v-if="deletingCategory?.children_count > 0"
                class="text-sm text-red-600 mt-2"
              >
                This category has
                {{ deletingCategory.children_count }} subcategories that will
                also be deleted.
              </p>
              <p
                v-if="deletingCategory?.parts_count > 0"
                class="text-sm text-red-600 mt-1"
              >
                This category has {{ deletingCategory.parts_count }} parts that
                will be affected.
              </p>
            </div>
          </div>
...
export default {
  ...
  setup() {
    ...
    const totalPartsCount = computed(() => {
      return categoriesStore.categories.reduce(
        (total, cat) => total + (cat.parts_count || 0),
        0,
      );
    });
