    ...
    <div class="bg-white shadow rounded-lg p-6">
      <div class="flex justify-between items-center">
        <div>
          ...
          <p class="text-gray-600 mt-2">Manage application settings and preferences</p>
        </div>
      </div>
    </div>
    ...
    <div class="bg-white shadow rounded-lg p-6">
      <div class="space-y-6">
        ...
        <div class="border-b border-gray-200 pb-6">
          <h3 class="text-lg font-medium text-gray-900 mb-4">AI Search Settings</h3>
          <div class="flex items-center justify-between">
            <div>
              <label class="text-sm font-medium text-gray-700">Enable AI Search</label>
              <p class="text-sm text-gray-500">Use AI-powered semantic search for better results</p>
            </div>
        ...
        <div class="border-b border-gray-200 pb-6">
          <h3 class="text-lg font-medium text-gray-900 mb-4">Bulk Search Settings</h3>
          <div class="space-y-4">
            <div>
              <label class="block text-sm font-medium text-gray-700 mb-2">Maximum Bulk Search Items</label>
              <input
              ...
              />
              <p class="text-sm text-gray-500 mt-1">Maximum number of items that can be searched in bulk</p>
            </div>
          </div>
        </div>
        ...
        <div class="border-b border-gray-200 pb-6">
          <h3 class="text-lg font-medium text-gray-900 mb-4">Telegram Bot Settings</h3>
          <div class="space-y-4">
            <div>
              <label class="block text-sm font-medium text-gray-700 mb-2">Admin Telegram IDs</label>
              <textarea
                v-model="adminIds"
                rows="3"
              ...
              ></textarea>
              <p class="text-sm text-gray-500 mt-1">Telegram user IDs that have admin access to the bot</p>
            </div>
          </div>
        </div>
