<template>
  <div class="space-y-6">
      ...
      <div class="flex justify-between items-center">
        <div>
          ...
          <p class="text-gray-600 mt-2">
            Track and manage customer leads with comprehensive profiles
          </p>
        </div>
        <div class="flex space-x-3">
          ...
          >
            <svg
              class="w-4 h-4 mr-2"
              :class="{ 'animate-spin': leadsStore.loading }"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
          ...
          <div class="flex items-center">
            ...
            <div class="ml-5 w-0 flex-1">
              <dl>
                ...
                <dd class="text-lg font-medium text-gray-900">
                  {{ leadsStore.stats.convertedLeads }}
                </dd>
              </dl>
            </div>
          </div>
          ...
          <div class="flex items-center">
            ...
            <div class="ml-5 w-0 flex-1">
              <dl>
                ...
                <dd class="text-lg font-medium text-gray-900">
                  {{ formatPercentage(leadsStore.stats.conversionRate) }}
                </dd>
              </dl>
            </div>
          </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div>
          ...
          >
            ...
            <option
              v-for="city in leadsStore.uniqueCities"
              :key="city"
              :value="city"
            >
              {{ city }}
    ...
    <div class="bg-white shadow rounded-lg">
        ...
        <div class="flex justify-between items-center">
          ...
          <div class="flex items-center space-x-4">
            <span class="text-sm text-gray-500">
              Showing {{ leadsStore.leads.length }} of
              {{ leadsStore.pagination.total }} leads
            </span>
            <select
              v-model="pageSize"
            ...
            >
              ...
              <td class="px-6 py-4 whitespace-nowrap">
                <div class="text-sm text-gray-900">
                  {{ leadsStore.getDisplayPhone(lead.phone_e164) }}
                </div>
                <div class="text-sm text-gray-500">
                  {{ leadsStore.getDisplayCity(lead.city) }}
                </div>
              </td>
              <td class="px-6 py-4 whitespace-nowrap">
                <span
              ...
              <td class="px-6 py-4 whitespace-nowrap">
                <div class="text-sm text-gray-900">
                  {{ lead.orders?.length || 0 }} orders
                </div>
                <div class="text-xs text-gray-500">
                  {{
                    lead.orders?.length > 0
                      ? formatDate(
                          lead.orders[lead.orders.length - 1].created_at,
                        )
                      : "No orders"
                  }}
                </div>
      ...
      <!-- Pagination -->
      <div
        v-if="leadsStore.pagination.totalPages > 1"
      ...
      >
        <div class="flex-1 flex justify-between sm:hidden">
          ...
          <button
            :disabled="
              leadsStore.pagination.page === leadsStore.pagination.totalPages
            "
        ...
        >
          <div>
            <p class="text-sm text-gray-700">
              ...
              <span class="font-medium">{{
                (leadsStore.pagination.page - 1) * leadsStore.pagination.limit +
                1
              }}</span>
              to
              <span class="font-medium">{{
                Math.min(
                  leadsStore.pagination.page * leadsStore.pagination.limit,
                  leadsStore.pagination.total,
                )
              }}</span>
              of
          ...
          <div>
            ...
            >
              ...
              <button
                :disabled="
                  leadsStore.pagination.page ===
                  leadsStore.pagination.totalPages
                "
