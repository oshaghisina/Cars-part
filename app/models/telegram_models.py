...
class TelegramUser(Base):
    ...
    link_tokens = relationship("TelegramLinkToken", back_populates="telegram_user", cascade="all, delete-orphan")
...
class TelegramLinkToken(Base):
    ...
    user_id = Column(Integer, ForeignKey("users.id"), nullable=True, index=True)  # For existing users
    ...
    action = Column(String(50), nullable=False, default="link_account")  # link_account, login, verify_phone
