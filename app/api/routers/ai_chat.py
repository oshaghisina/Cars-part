...
async def handle_performance_query(message: str, context: Dict[str, Any]) -> str:
    ...
    try:
        ...
        if resource_usage:
            ...
            utilization = resource_usage.get("utilization", {})
            ...
            response += f"- Tokens/min: {current_usage.get('tokens_this_minute', 0)}/{limits.get('max_tokens_per_minute', 0)}\n"
            response += f"- Cost/hour: ${current_usage.get('cost_this_hour', 0):.2f}/${limits.get('max_cost_per_hour', 0)}\n"
