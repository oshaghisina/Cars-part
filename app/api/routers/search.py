...
async def search_module(module: str, search_request: AdvancedSearchRequest, db: Session):
    ...
    if module == 'parts':
        ...
        if search_request.query:
            text_filter = or_(
                func.lower(Part.part_name).contains(search_request.query.lower()),
                func.lower(Part.brand_oem).contains(search_request.query.lower()),
                func.lower(Part.oem_code).contains(search_request.query.lower()),
                func.lower(Part.description).contains(search_request.query.lower())
            )
        ...
        if search_request.filters:
            ...
            if search_request.filters.price_min:
                query = query.filter(Part.price >= search_request.filters.price_min)
            if search_request.filters.price_max:
                query = query.filter(Part.price <= search_request.filters.price_max)
        ...
        if search_request.query:
            text_filter = or_(
                func.lower(Order.customer_name).contains(search_request.query.lower()),
                func.lower(Order.customer_phone).contains(search_request.query.lower()),
                func.lower(Order.notes).contains(search_request.query.lower())
            )
            query = query.filter(text_filter)
        ...
        if search_request.query:
            text_filter = or_(
                func.lower(Lead.first_name).contains(search_request.query.lower()),
                func.lower(Lead.last_name).contains(search_request.query.lower()),
                func.lower(Lead.phone_e164).contains(search_request.query.lower()),
                func.lower(Lead.city).contains(search_request.query.lower())
            )
            query = query.filter(text_filter)
        ...
        if search_request.query:
            text_filter = or_(
                func.lower(User.username).contains(search_request.query.lower()),
                func.lower(User.email).contains(search_request.query.lower()),
                func.lower(User.first_name).contains(search_request.query.lower()),
                func.lower(User.last_name).contains(search_request.query.lower())
            )
            query = query.filter(text_filter)
