...
async def get_auth_logs(
    limit: int = 100, offset: int = 0, level: str = "INFO", current_user=Depends(require_admin)
) -> Dict[str, Any]:
    """
    ...
    try:
        ...
        logs = {
            ...
            "pagination": {"limit": limit, "offset": offset, "total": 2, "has_more": False},
            "metadata": {"data_source": "mock", "last_updated": datetime.utcnow().isoformat()},
        }
